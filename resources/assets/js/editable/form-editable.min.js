var FormEditable=function() {
    ...
    ,
    i=function() {
        "inline"==App.getURLParameter("mode")?($.fn.editable.defaults.mode="inline", $("#inline").attr("checked", !0), jQuery.uniform.update("#inline")):($("#inline").attr("checked", !1), jQuery.uniform.update("#inline")),
        $.fn.editable.defaults.inputclass="form-control",
        $.fn.editable.defaults.url="/post",
        $("#username").editable( {
            url: "/post", type: "text", pk: 1, name: "username", title: "Enter username"
        }
        ),
        $(".manufacturer_part_number").editable( {
            validate:function(a) {
        ...
        $("#sex").editable( {
            prepend:"not selected", inputclass:"form-control", source:[ {
                value: 1, text: "Male"
            }
            , {
                value: 2, text: "Female"
        ...
        $("#event").editable( {
            placement:App.isRTL()?"left":"right", combodate: {
                firstItem: "name"
            }
        }
        ),
        $("#meeting_start").editable( {
            format:"yyyy-mm-dd hh:ii", viewformat:"dd/mm/yyyy hh:ii", validate:function(a) {
                return a&&10==a.getDate()?"Day cant be 10!": void 0
            }
            , datetimepicker: {
                rtl: App.isRTL(), todayBtn: "linked", weekStart: 1
            }
        }
        ),
        $("#comments").editable( {
        ...
        $("#tags").editable( {
            inputclass:"form-control input-medium", select2: {
                tags: ["html", "javascript", "css", "ajax"], tokenSeparators: [",", " "]
            }
        }
        );
        var a=[];
        ...
        $("#country").editable( {
            inputclass: "form-control input-medium", source: a
        }
        ),
        $("#address").editable( {
            url:"/post", value: {
                city: "San Francisco", street: "Valencia", building: "#24"
            }
            , validate:function(a) {
