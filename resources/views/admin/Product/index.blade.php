    ...
    $(document).ready(function(){
        ...
        oTable =  $('#prod_index').DataTable({
            ...
            fnCreatedRow: function(nRow, aData, iDataIndex) {
                ...
                $('td:eq(3)', nRow).html('<a href="<?php echo url("/admin/product") ?>/'+aData.id+'"><i class="fa fa-eye icon-muted fa-fw icon-space"></i></a>'+'<a href="<?php echo url("/admin/product") ?>/'+aData.id+'/edit"><i class="fa icon-muted fa-pencil icon-space"></i></a>');
            },
